 ...
 * @extends {ActorSheet}
 */
export class WarlordsActorSheet extends ActorSheet {
    /** @override */
    static get defaultOptions() {
        return mergeObject(super.defaultOptions, {
            classes: ["warlords", "sheet", "actor"],
            template: "systems/warlords/templates/actor/actor-sheet.html",
            width: 600,
            height: 600,
            tabs: [
                {
    ...
    /** @override */
    get template() {
        return `systems/warlords/templates/actor/actor-${this.actor.type}-sheet.html`;
    }
